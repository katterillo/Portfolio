...
const Resume = () => {
    return (
        ...
        <br/>
    <div class="m-10 text-center text-gray-500 bg-white w-6/12 m-auto hover:text-white hover:bg-gray-500 2xl:w-3/12 rounded transition duration-500 ease-in-out ">
